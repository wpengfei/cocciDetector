...
def print_and_log(filename,first,second,count):
	...
	logfile = open('freebsd_RR_result.txt','a')
...
|
	copyin((T1)usr, exp1, size1)@p1
|
	copyin(usr, exp1, size1)@p1
|
	copyin_nofault((T1)usr, exp1, size1)@p1
|
	copyin_nofault(usr, exp1, size1)@p1
...
|
	copyin((T2)usr, exp2, size2)@p2
|
	copyin(usr, exp2, size2)@p2
|
	copyin_nofault((T2)usr, exp2, size2)@p2
|
	copyin_nofault(usr, exp2, size2)@p2
)	
	...
	}
...
|
	copyin((T1)alias, exp1, size1)@p1
|
	copyin(alias, exp1, size1)@p1
|
	copyin_nofault((T1)alias, exp1, size1)@p1
|
	copyin_nofault(alias, exp1, size1)@p1
)
	...	
	when != usr += offset
	when != usr = usr + offset
...
|
	copyin((T2)alias, exp2, size2)@p2
|
	copyin(alias, exp2, size2)@p2
|
	copyin_nofault((T2)alias, exp2, size2)@p2
|
	copyin_nofault(alias, exp2, size2)@p2
)
	... 
	}
...
|
	__get_user(exp1, &(usr->e1))@p1
|
	copyin((T1)usr->e1, exp1, size1)@p1
|
	copyin(usr->e1, exp1, size1)@p1
|
	copyin(&(usr->e1), exp1, size1)@p1
|
	copyin_nofault((T1)usr->e1, exp1, size1)@p1
|
	copyin_nofault(usr->e1, exp1, size1)@p1
|
	copyin_nofault(&(usr->e1), exp1, size1)@p1
)
	...	
