...
def print_and_log(filename,first,second,count):
	...
	logfile = open('linux_WR_result.txt','a')
...
|
	copy_to_user((T1)usr, exp1, size1)@p1
|
	copy_to_user(usr, exp1, size1)@p1
|
	__copy_to_user((T1)usr, exp1, size1)@p1
|
	__copy_to_user(usr, exp1, size1)@p1
...
|
	copy_to_user((T1)alias, exp1, size1)@p1
|
	copy_to_user(alias, exp1, size1)@p1
|
	__copy_to_user((T1)alias, exp1, size1)@p1
|
	__copy_to_user(alias, exp1, size1)@p1
)
	...	
	when != usr += offset
	when != usr = usr + offset
...
|
	__put_user(exp1, &(usr->e1))@p1
|
	copy_to_user((T1)usr->e1, exp1, size1)@p1
|
	copy_to_user(usr->e1, exp1, size1)@p1
|
	copy_to_user(&(usr->e1), exp1, size1)@p1
|
	__copy_to_user((T1)usr->e1, exp1, size1)@p1
|
	__copy_to_user(usr->e1, exp1, size1)@p1
|
	__copy_to_user(&(usr->e1), exp1, size1)@p1
)
	...	
