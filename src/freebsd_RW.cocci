...
def print_and_log(filename,first,second,count):
	...
	logfile = open('freebsd_RW_result.txt','a')
...
|
	copyout(exp2, (T2)usr, size2)@p2
|
	copyout(exp2, usr, size2)@p2
|
	copyout_nofault(exp2, (T2)usr, size2)@p2
|
	copyout_nofault(exp2, usr, size2)@p2
)	
	...
	}
...
|
	copyout(exp2, (T2)alias, size2)@p2
|
	copyout(exp2, alias, size2)@p2
|
	copyout_nofault(exp2, (T2)alias, size2)@p2
|
	copyout_nofault(exp2, alias, size2)@p2
)
	... 
	}
